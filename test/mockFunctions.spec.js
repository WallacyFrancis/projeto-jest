...
// references: https://serprogramador.com.br/artigos/topico/javascript/Como-calcular-a-operacao-matematica-de-fatorial-com-JavaScript
function fac(n) {
  const fatorial = n;
  let resultado = fatorial;
  const primeiroMultipicador = fatorial - 1;
